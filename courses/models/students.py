...
#   Partner fields related to student
    ...
    partner_phone = fields.Char(related='partner_id.phone', string="Teléfono", store="True", readonly="False")
    partner_email = fields.Char(related='partner_id.email', string="Correo Electrónico", store="True", readonly="False")
    partner_country = fields.Many2one('res.country', related='partner_id.country_id', string="País", store="True", readonly="False")
    partner_company = fields.Many2one('res.partner', related='partner_id.parent_id', string="Empresa", store="True", readonly="False")
    partner_city = fields.Char(related='partner_id.city', string="Ciudad", store="True", readonly="False")
    partner_function = fields.Char(related='partner_id.function', string="Puesto de Trabajo", store="True", readonly="False")
