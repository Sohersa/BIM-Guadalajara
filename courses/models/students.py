...
class students(models.Model):
    ...
    partner_country = fields.Many2one(related='partner_id.country_id', string="País")
    partner_city = fields.Many2one(related='partner_id.city_id', string="Ciudad")
    partner_company = fields.Many2one(related='partner_id.perent_id', string="Empresa")
    partner_function = fields.Char(related='partner_id.function', string="Puesto de Trabajo")
    partner_title = fields.Many2one(related='partner_id.title', string="Profesión")
